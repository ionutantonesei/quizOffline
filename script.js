...
buton1.addEventListener('click',()=>{
    ...
    else if(validareButon1 == 1 && intrebari[i].raspuns[0][1] == false||intrebari[i].raspuns[0][1] == null) corect = 0;
});
buton2.addEventListener('click',()=>{
    ...
    else if(validareButon2 == 1 && intrebari[i].raspuns[1][1] == false||intrebari[i].raspuns[1][1] == null) corect = 0;
});
buton3.addEventListener('click',()=>{
    ...
    else if(validareButon3 == 1 && intrebari[i].raspuns[2][1] == false||intrebari[i].raspuns[2][1] == null) corect = 0;
});
buton4.addEventListener('click',()=>{
    ...
    else if(validareButon4 == 1 && intrebari[i].raspuns[3][1] == false ||intrebari[i].raspuns[3][1] == null) corect = 0;
});
